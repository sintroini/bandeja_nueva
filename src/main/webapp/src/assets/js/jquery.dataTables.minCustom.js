...
(function(X,l,n) {
    var L= function(h) {
        var j= function(e) {
            ...
            function ea(a,b) {
                ...
                if(null===c.nTr) {
                    ...
                    for(var i=0,f=a.aoColumns.length;i<f;i++) {
                        ...
                        null!==g.sClass&&(d.className=g.sClass);g.bVisible?(c.nTr.appendChild(d),c._anHidden[i]=null):c._anHidden[i]=d;
            ...
            function za(a) {
            	var filtros_avanzados = '		<div class="btn btn-primary dropdown-toggle" id="filtrosAvanzados" onclick="openModalfiltros();"><div class="head " data-toggle="tooltip" title="Filtros avanzados">' +
														'Filtros Avanzados <i class="halflings-icon chevron-down"></i>' +
													'</div></div>';
            	
                var b=a.oPreviousSearch,c=a.oLanguage.sSearch,c=-1!==c.indexOf("_INPUT_")?c.replace("_INPUT_",'<input type="text" />'):""===c?'<input type="text" class="span7 search" />' + filtros_avanzados:c+' <input type="text" class="span7 search" />',d=l.createElement("div");
            ...
            function ba(a) {
                ...
                if(!1===a.bInitialised)
                    ...
                    a.oFeatures.bSort?O(a):a.oFeatures.bFilter?K(a,a.oPreviousSearch):(a.aiDisplay=a.aiDisplayMaster.slice(),y(a),x(a));null!==a.sAjaxSource&&!a.oFeatures.bServerSide?(c=[],ka(a,c),a.fnServerData.call(a.oInstance,a.sAjaxSource,
                        c, function(c) {
            ...
            function La(a) {
                ...
                if(h(a.nTable).outerWidth()<i) {
                    ...
                    null!==a.nTFoot&&(a.nScrollFoot.style.width=q(g));""===a.oScroll.sX?D(a,1,"The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width."):
            ...
            function da(a) {
                ...
                if(i==j.length&&0===b&&d==i&&""===a.oScroll.sX&&""===a.oScroll.sY)
                    ...
                    j=N(a,f);
                    for(f=d=0;f<i;f++) {
                        var k=a.aoColumns[f];k.bVisible&&null!==k.sWidthOrig&&""!==k.sWidthOrig?j[f-d].style.width=q(k.sWidthOrig):k.bVisible?j[f-d].style.width="":d++
                    }
                    for(f=0;f<i;f++)
            ...
            function Oa(a,b) {""===a.oScroll.sX&&""!==a.oScroll.sY?(h(b).width(),b.style.width=q(h(b).outerWidth()-
            ...
            function O(a,b) {
                ...
                a.bSorted=!0;
                h(a.oInstance).trigger("sort",a);a.oFeatures.bFilter?K(a,a.oPreviousSearch,1):(a.aiDisplay=a.aiDisplayMaster.slice(),a._iDisplayStart=0,y(a),x(a))
            }
                            ...
                            if(b.shiftKey) {
                                for(var f=!1,h=0;h<a.aaSorting.length;h++)
                                    if(a.aaSorting[h][0]==c) {
                                        f=!0;
                                        d=a.aaSorting[h][0];
                                        e=a.aaSorting[h][2]+1;a.aoColumns[d].asSorting[e]?
            ...
            this.each( function() {
                ...
                if("table"!=this.nodeName.toLowerCase())
                    ...
                    z(g,"aoPreDrawCallback",e.fnPreDrawCallback,"user");g.oFeatures.bServerSide&&
                    g.oFeatures.bSort&&g.oFeatures.bSortClasses?z(g,"aoDrawCallback",P,"server_side_sort_classes"):g.oFeatures.bDeferRender&&z(g,"aoDrawCallback",P,"defer_sort_classes");e.bJQueryUI?(h.extend(g.oClasses,j.ext.oJUIClasses),e.sDom===j.defaults.sDom&&"lfrtip"===j.defaults.sDom&&(g.sDom='<"H"lfr>t<"F"ip>')):h.extend(g.oClasses,j.ext.oStdClasses);
                    ...
                    null!==e.aaData&&(f=!0);""!==e.oLanguage.sUrl?(g.oLanguage.sUrl=e.oLanguage.sUrl,h.getJSON(g.oLanguage.sUrl,null, function(a) {
                            pa(a);
        ...
        j.defaults={aaData:null,aaSorting:[[0,"asc"]],aaSortingFixed:null,aLengthMenu:[5,10,20,50],aoColumns:null,aoColumnDefs:null,aoSearchCols:[],asStripeClasses:null,bAutoWidth:!0,bDeferRender:!1,bDestroy:!1,bFilter:!0,bInfo:!0,bJQueryUI:!1,bLengthChange:!0,
            ...
            },fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:5,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},
                oPaginate:{sFirst:"Primera",sLast:"Ultima",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No existen datos a mostrar",sInfo:"Items _START_ de _END_ total  _TOTAL_ ",sInfoEmpty:"Items 0 de 0  total 0 ",sInfoFiltered:"(filtrado en _MAX_ items en total)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"mostrar _MENU_ items",sLoadingRecords:"Loading...",sProcessing:"Procesando...",sSearch:"",sUrl:"",sZeroRecords:"No se encuentran resultados para dicha busqueda"},oSearch:h.extend({},j.models.oSearch),sAjaxDataProp:"aaData",
